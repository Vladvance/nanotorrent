...
/*
** pack754() -- pack a floating point16_t number into IEEE-754 format
*/ 
...
/*
** unpack754() -- unpack a floating point16_t number from IEEE-754 format
*/ 
...
/*
** packi16() -- store a 16-bit int16_t into a char buffer (like htons())
*/ 
...
/*
** packi32() -- store a 32-bit int16_t into a char buffer (like htonl())
*/ 
...
/*
** packi64() -- store a 64-bit int16_t into a char buffer (like htonl())
*/ 
...
/*
** unpacki16() -- unpack a 16-bit int16_t from a char buffer (like ntohs())
*/ 
...
/*
** unpacki32() -- unpack a 32-bit int16_t from a char buffer (like ntohl())
*/ 
...
/*
** unpacki64() -- unpack a 64-bit int16_t from a char buffer (like ntohl())
*/ 
...
void unpack(unsigned char *buf, char *format, ...)
{
	...
	char *s;
    uint16_t len, maxstrlen=0, count;
